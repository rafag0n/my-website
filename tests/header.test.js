...
describe('Header', () => {
    ...
    it('Opens menu properly', () => {
        expect(screen.getByTestId(sidenavContents)).toHaveClass(sidenavContents.concat(hidden));
        fireEvent.click(screen.getByTestId(sidenavOpen));
        expect(screen.getByTestId(sidenavContents)).toHaveClass(sidenavContents.concat(visible));
    })
